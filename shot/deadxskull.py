...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.deadxskull/sessions/'
        self.pixiewps_dir = f'{user_home}/.deadxskull/pixiewps/'
...
def usage():
    return """
deadxskullPin 0.0.2   ,  by anonymous and Francisco
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='deadxskullPin 0.0.2   ,  by anonymous and Francisco',
